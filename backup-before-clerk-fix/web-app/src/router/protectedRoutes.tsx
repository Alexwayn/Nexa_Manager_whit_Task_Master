...
export const AdminRoutes = () => (
  <Routes>
    ...
    <Route
      path='/settings'
      element={
        <OrganizationProtectedRoute requiredRole='admin' organizationRequired={true}>
          <Settings />
        </OrganizationProtectedRoute>
      }
    />
...
export const RoleBasedRoutes = () => (
  <Routes>
    ...
    <Route
      path='/member-area'
      element={
        <OrganizationProtectedRoute requiredRole='basic_member' organizationRequired={true}>
          <div>Member Area</div>
        </OrganizationProtectedRoute>
      }
    />
...
export const ConditionalContentComponent = () => {
  ...
  return (
    <div>
      ...
      {checkRole('admin') && <button>Admin Settings</button>}

      {checkPermission('manage_users') && <button>Manage Users</button>}

      {checkPermission('view_analytics') && <button>View Analytics</button>}
    </div>
  );
};
