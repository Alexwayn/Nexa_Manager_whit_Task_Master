...
export const EVENT_PRIORITY_MAP = {
  // Critical events
  'system:error': EVENT_PRIORITIES.CRITICAL,
  'schedule:failed': EVENT_PRIORITIES.CRITICAL,
  'alert:triggered': EVENT_PRIORITIES.CRITICAL,
  
  // High priority events
  'notification:created': EVENT_PRIORITIES.HIGH,
  'report:generated': EVENT_PRIORITIES.HIGH,
  'schedule:executed': EVENT_PRIORITIES.HIGH,
  'task:completed': EVENT_PRIORITIES.HIGH,
  
  // Medium priority events
  'report:updated': EVENT_PRIORITIES.MEDIUM,
  'schedule:updated': EVENT_PRIORITIES.MEDIUM,
  'task:updated': EVENT_PRIORITIES.MEDIUM,
  'widget:updated': EVENT_PRIORITIES.MEDIUM,
  
  // Low priority events
  'metric:updated': EVENT_PRIORITIES.LOW,
  'chart:updated': EVENT_PRIORITIES.LOW,
  'user:online': EVENT_PRIORITIES.LOW,
  
  // Info events
  'system:health': EVENT_PRIORITIES.INFO,
  'system:performance': EVENT_PRIORITIES.INFO,
  'user:offline': EVENT_PRIORITIES.INFO
};
...
export const getEventPriority = (eventType) => {
  return EVENT_PRIORITY_MAP[eventType] || EVENT_PRIORITIES.MEDIUM;
};
