          ...
          {categories.map((category, index) => {
            ...
            return (
              <circle
                ...
                fill='none'
                stroke={
                  category.color.replace('bg-', '').replace('-500', '') === 'blue'
                    ? '#3b82f6'
                    : category.color.replace('bg-', '').replace('-500', '') === 'teal'
                      ? '#14b8a6'
                      : category.color.replace('bg-', '').replace('-400', '') === 'yellow'
                        ? '#facc15'
                        : category.color.replace('bg-', '').replace('-400', '') === 'orange'
                          ? '#fb923c'
                          : '#a855f7'
                }
                strokeWidth='40'
