              ...
              <div className="flex flex-col items-center mb-8">
                <div className="relative w-48 h-48 mb-6">
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center">
                    <span className="text-4xl font-bold text-blue-600">{businessHealthScore}</span>
                    <span className="text-gray-500 text-sm">
                      {t('businessHealth.outOf100')}
                    </span>
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-gray-900">
                      {t('businessHealth.clientRetention')}
                    </span>
                  </div>
                  <span className="text-gray-900 font-medium">
                    {t('businessHealth.good')}
                  </span>
                </div>
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-2">
                ...
                <div className="relative w-40 h-40">
                  ...
                  <div className="absolute inset-4 bg-white rounded-full flex items-center justify-center">
                    <div className="text-center">
                      <div className="text-xl font-bold text-gray-900">{t('values.totalRevenue')}</div>
                      <div className="text-xs text-gray-500">
                        {t('revenueStreams.total')}
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 w-full">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="text-center">
                  ...
                  <div className="text-xl font-semibold text-amber-600">{t('values.pendingAmount')}</div>
                </div>
                <div className="text-center">
                  <div className="text-gray-500 text-sm">
                    {t('invoiceTracker.paid30Days')}
                  </div>
                  <div className="text-xl font-semibold text-green-600">{t('values.paidAmount')}</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="lg:col-span-5 bg-white rounded-xl shadow-sm p-6 w-full">
              ...
              <div className="mt-6 pt-6 border-t border-gray-100">
                <div className="grid grid-cols-3 gap-4 text-center">
                  <div>
                    <div className="text-2xl font-bold text-blue-600">{t('values.unreadCount')}</div>
                    <div className="text-sm text-gray-500">{t('performance.unread')}</div>
                  </div>
                  <div>
                    <div className="text-2xl font-bold text-green-600">{t('values.thisWeekCount')}</div>
                    <div className="text-sm text-gray-500">
                      {t('performance.thisWeek')}
                    </div>
                  </div>
                  <div>
                    <div className="text-2xl font-bold text-gray-600">{t('values.totalCount')}</div>
            ...
            <div className="lg:col-span-3 bg-white rounded-xl shadow-sm p-6 w-full">
              ...
              <div className="space-y-6">
                <div className="border-b border-gray-100 pb-4">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-2xl font-bold text-gray-900">{revenueData.monthly}</span>
                    <span className="text-gray-500 text-sm">
                ...
                <div className="border-b border-gray-100 pb-4">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-2xl font-bold text-gray-900">{upcomingEvents.count}</span>
