    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-blue-50 border-b border-gray-200">
        <div className="px-6 py-3">
          <h1 className="text-blue-600 text-base font-normal">
            Financial Tracking
          </h1>
        </div>
      </div>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-sm text-gray-500">
                    Total Outstanding: <span className="font-semibold text-gray-900">$100,000</span>
                  </span>
          ...
          <div className="space-y-8">
                ...
                <div className="flex items-center justify-center mb-6">
                  <div className="relative w-40 h-40">
                    <svg className="w-40 h-40 transform -rotate-90" viewBox="0 0 100 100">
                      <circle cx="50" cy="50" r="35" stroke="#3B82F6" strokeWidth="15" fill="transparent" strokeDasharray="110 251" />
                      <circle cx="50" cy="50" r="35" stroke="#10B981" strokeWidth="15" fill="transparent" strokeDasharray="80 281" strokeDashoffset="-110" />
                      <circle cx="50" cy="50" r="35" stroke="#F59E0B" strokeWidth="15" fill="transparent" strokeDasharray="61 300" strokeDashoffset="-190" />
                    </svg>
                  </div>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div className="space-y-4">
                  {[
                    { category: 'Salaries & Benefits', amount: '$12,500', percentage: 68, color: 'bg-blue-500' },
                    { category: 'Operations', amount: '$3,200', percentage: 17, color: 'bg-green-500' },
                    { category: 'Marketing', amount: '$1,800', percentage: 10, color: 'bg-yellow-500' },
                    { category: 'Software & Tools', amount: '$1,000', percentage: 5, color: 'bg-purple-500' }
                  ].map((expense, index) => (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    {[
                      { metric: 'Revenue Growth', value: '+18.2%', trend: 'up', color: 'text-green-600' },
                      { metric: 'Client Acquisition', value: '+12.8%', trend: 'up', color: 'text-green-600' },
                      { metric: 'Average Invoice Value', value: '+8.5%', trend: 'up', color: 'text-green-600' },
                      { metric: 'Payment Velocity', value: '-15.3%', trend: 'down', color: 'text-green-600' }
                    ].map((item, index) => (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  {[
                    ...
                    <div key={index} className="space-y-2">
                      ...
                      <div className="flex justify-between text-xs">
                        ...
                        {item.progress > 0 && (
                          <span className={item.progress >= 100 ? 'text-green-600' : 'text-yellow-600'}>
                            {item.progress}%
                          </span>
                        )}
                      </div>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div className="space-y-4">
                  ...
                  {[
                    { category: 'Marketing & Sales', allocated: '$45,000', spent: '$38,200', percentage: 85 },
                    { category: 'Operations', allocated: '$125,000', spent: '$98,500', percentage: 79 },
                    { category: 'Research & Development', allocated: '$85,000', spent: '$72,300', percentage: 85 },
                    { category: 'Administration', allocated: '$35,000', spent: '$28,900', percentage: 83 }
                  ].map((item, index) => (
                    <div key={index} className="space-y-2">
                      <div className="flex justify-between">
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div className="space-y-4">
                  {[
                    { scenario: 'Best Case', revenue: '$485,000', probability: '25%', color: 'text-green-600' },
                    { scenario: 'Most Likely', revenue: '$425,000', probability: '50%', color: 'text-blue-600' },
                    { scenario: 'Conservative', revenue: '$385,000', probability: '25%', color: 'text-yellow-600' }
                  ].map((scenario, index) => (
