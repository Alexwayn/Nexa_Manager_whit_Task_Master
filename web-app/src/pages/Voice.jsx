  ...
  const tutorials = [
    {
      ...
      duration: '3:45',
      thumbnail: 'https://images.unsplash.com/photo-1589254065878-42c9da997008?w=424&h=160&fit=crop&auto=format',
    },
    {
      title: 'Advanced Voice Navigation',
      description: 'Master complex navigation and multi-step commands',
      duration: '5:20',
      thumbnail: 'https://images.unsplash.com/photo-1560472354-b33ff0c44a43?w=424&h=160&fit=crop&auto=format',
    },
    {
      title: 'Voice Document Creation',
      description: 'Create and edit documents using only your voice',
      duration: '4:15',
      thumbnail: 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?w=424&h=160&fit=crop&auto=format',
    },
  ];
  ...
  const tips = [
    {
      ...
      description: 'Speak at a normal pace and volume. The assistant works best when you use natural language rather than robotic commands.',
    },
    {
      title: 'Use Command Keywords',
      description: 'Start with action words like "open," "create," "show," or "find" followed by the subject of your command.',
    },
    {
      title: 'Quiet Environment',
      description: 'Use the voice assistant in a quiet environment for optimal recognition accuracy and performance.',
    },
    {
      title: 'Microphone Distance',
      description: 'Position yourself about 8-12 inches from your microphone for the best voice recognition results.',
    },
  ];
          ...
          <div className="px-8 py-8">
            ...
            <div className="flex justify-between items-start mb-8">
              <div>
                ...
                <p className="text-gray-600 text-sm max-w-md">
                  Use voice commands to navigate and perform actions in Nexa Manager. Simply activate the voice assistant and speak your command.
                </p>
              </div>
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
              ...
              <div className="text-left text-gray-600 text-sm leading-6 ml-8 space-y-1">
                <p>1. Click the "Activate Voice" button or say "Hey Nexa" to activate the voice assistant</p>
