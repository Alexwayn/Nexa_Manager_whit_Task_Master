        ...
        <div className="grid grid-cols-4 gap-6 mt-6">
          <div className="bg-white p-4 rounded-lg border border-gray-200">
            ...
            <div className="mt-2 flex items-center">
              <span className="text-green-600 text-sm">↗ {stats.totalDocumentsIncrease}% increase from last month</span>
            </div>
          </div>
          ...
          <div className="bg-white p-4 rounded-lg border border-gray-200">
            ...
            <div className="mt-2 flex items-center">
              <span className="text-green-600 text-sm">↗ {stats.recentUploadsIncrease}% increase from last month</span>
            </div>
          </div>
          ...
          <div className="bg-white p-4 rounded-lg border border-gray-200">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-semibold text-gray-900">{stats.sharedDocuments}</p>
                <p className="text-xs text-gray-500">With team and clients</p>
              </div>
            ...
            <div className="mt-2 flex items-center">
              <span className="text-green-600 text-sm">↗ {stats.sharedDocumentsIncrease}% increase from last month</span>
            </div>
          </div>
          ...
          <div className="bg-white p-4 rounded-lg border border-gray-200">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-500">48% of total storage</p>
              </div>
        ...
        <div className="flex-1 p-6">
          ...
          <div className="bg-white p-4 rounded-lg border border-gray-200 mb-6">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-2">
                <button className="px-3 py-2 text-sm text-gray-600 hover:text-gray-900 border-r border-gray-200">
                  All Types
                </button>
                <button className="px-3 py-2 text-sm text-gray-600 hover:text-gray-900 border-r border-gray-200">
                  Last 30 Days
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {documents.map((doc) => (
                  <tr key={doc.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        <div className="w-6 h-6 bg-gray-300 rounded-full flex items-center justify-center text-xs text-white font-medium mr-2">
                          {doc.owner.split(' ').map(n => n[0]).join('')}
                        </div>
                        <span className="text-sm text-gray-900">{doc.owner}</span>
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
          ...
          <div className="mt-6 flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              ...
              <button className="px-3 py-1 text-sm text-gray-700 hover:text-gray-900">2</button>
              <button className="px-3 py-1 text-sm text-gray-700 hover:text-gray-900">3</button>
              <button className="px-3 py-1 text-sm text-gray-500 hover:text-gray-700">
                Next
              </button>
            </div>
          ...
          <div className="grid grid-cols-4 gap-4 mt-8">
            <div className="bg-blue-600 text-white p-6 rounded-lg text-center cursor-pointer hover:bg-blue-700 transition-colors">
              ...
              <p className="text-sm opacity-90">Upload new files to your document storage</p>
              <button className="mt-4 bg-white bg-opacity-20 text-white px-4 py-2 rounded text-sm font-medium hover:bg-opacity-30 transition-colors">
                Upload Now
              </button>
            </div>
            ...
            <div className="bg-green-600 text-white p-6 rounded-lg text-center cursor-pointer hover:bg-green-700 transition-colors">
              ...
              <p className="text-sm opacity-90">Organize your documents in a folder structure</p>
              <button className="mt-4 bg-white bg-opacity-20 text-white px-4 py-2 rounded text-sm font-medium hover:bg-opacity-30 transition-colors">
                Create Now
              </button>
            </div>
            ...
            <div className="bg-orange-600 text-white p-6 rounded-lg text-center cursor-pointer hover:bg-orange-700 transition-colors">
              ...
              <p className="text-sm opacity-90">Request documents from clients or team members</p>
              <button className="mt-4 bg-white bg-opacity-20 text-white px-4 py-2 rounded text-sm font-medium hover:bg-opacity-30 transition-colors">
                Request Now
              </button>
            </div>
            ...
            <div className="bg-purple-600 text-white p-6 rounded-lg text-center cursor-pointer hover:bg-purple-700 transition-colors">
              ...
              <p className="text-sm opacity-90">Archive documents you no longer need</p>
              <button className="mt-4 bg-white bg-opacity-20 text-white px-4 py-2 rounded text-sm font-medium hover:bg-opacity-30 transition-colors">
                Archive
              </button>
            </div>
