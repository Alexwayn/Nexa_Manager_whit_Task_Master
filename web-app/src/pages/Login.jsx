...
const Login = () => {
  ...
  useEffect(() => {
    document.title = 'NexaManager - Accesso';
  }, []);
            ...
            <div className='mt-8'>
              <blockquote className='relative'>
                ...
                <p className='text-white/90 text-sm italic leading-relaxed pl-6'>
                  Con NexaManager gestiamo la nostra azienda in modo più efficiente e professionale. 
                  Un vero game-changer per il nostro business.
                </p>
                <footer className='mt-3 pl-6'>
                  <p className='text-white font-medium text-sm'>Marco Bianchi</p>
                  <p className='text-blue-100/70 text-xs'>Direttore, InnovaTech Roma</p>
                </footer>
              </blockquote>
            </div>
          </div>
        ...
        <div className='flex-1 flex items-center justify-center p-8 bg-gray-50'>
          <div className='w-full max-w-md'>
            ...
            <div className='lg:hidden mb-8 text-center'>
              ...
              <h2 className='text-2xl font-semibold text-gray-900'>Accedi al tuo account</h2>
            </div>

            {/* Desktop Header - Centered */}
            <div className='hidden lg:block mb-8 text-center'>
              <h2 className='text-2xl font-semibold text-gray-900 mb-3'>Accedi al tuo account</h2>
              <p className='text-gray-600 text-center'>Bentornato! Inserisci le tue credenziali</p>
            </div>
            ...
            <div className='mt-6 space-y-2'>
              <div className='flex items-center text-sm text-gray-600'>
                ...
                <span>Accesso sicuro e crittografato</span>
              </div>
              <div className='flex items-center text-sm text-gray-600'>
                <CheckIcon className='w-4 h-4 text-green-500 mr-2 flex-shrink-0' />
              ...
              <div className='flex items-center text-sm text-gray-600'>
                <CheckIcon className='w-4 h-4 text-green-500 mr-2 flex-shrink-0' />
                <span>Supporto 24/7 disponibile</span>
              </div>
            </div>
