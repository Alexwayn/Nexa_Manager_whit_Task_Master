...
export default function OrganizationManagement() {
  ...
  const { isAdmin, getUserRole, needsOrganizationCreation, needsOrganizationSelection } =
        ...
        <div className='max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8'>
          <div className='text-center mb-8'>
            ...
            <p className='mt-2 text-gray-600 dark:text-gray-400'>
              {safeT(
                'organization.createFirstDesc',
                'Get started by creating your organization to collaborate with your team.',
              )}
            </p>
          </div>
        ...
        return (
          <div className='space-y-6'>
              ...
              <div className='flex items-center space-x-4'>
                ...
                <div>
                  ...
                  <p className='text-gray-600 dark:text-gray-400'>
                    {organization?.membersCount || 0} {safeT('organization.members', 'members')} •{' '}
                    {safeT('navigation.organization.current', 'Current Organization')}
                  </p>
            ...
            <div className='bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden'>
              <OrganizationProfile routing='hash' appearance={commonAppearance} />
            </div>
          </div>
        );
          ...
          <div className='space-y-6'>
            ...
            <div className='bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6'>
              ...
              <p className='text-gray-600 dark:text-gray-400 mb-6'>
                {safeT(
                  'organization.settingsDesc',
                  'Configure organization preferences, security settings, and integrations.',
                )}
              </p>
              ...
              <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
                <button className='p-4 border border-gray-200 dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors text-left'>
                  ...
                  <p className='text-sm text-gray-600 dark:text-gray-400'>
                    {safeT(
                      'organization.generalSettingsDesc',
                ...
                <button className='p-4 border border-gray-200 dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors text-left'>
                  ...
                  <p className='text-sm text-gray-600 dark:text-gray-400'>
                    {safeT(
                      'organization.memberSettingsDesc',
                      'Default roles and member permissions',
                    )}
                  </p>
                </button>
              </div>
        ...
        return (
          <div className='bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6'>
            <div className='text-center py-12'>
              ...
              <p className='mt-2 text-gray-600 dark:text-gray-400'>
                {safeT(
                  'organization.analyticsDesc',
                  'Organization usage analytics and insights will be available soon.',
                )}
              </p>
            </div>
          </div>
