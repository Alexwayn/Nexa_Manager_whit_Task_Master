// Mock for VoiceActivationButton component
const React = require('react');

// Mock VoiceActivationButton that simulates the real component behavior
const VoiceActivationButton = ({ size = 'md', className = '', onClick, ...props }) => {
  // Get the mock voice assistant from the test context
...
module.exports = VoiceActivationButton;