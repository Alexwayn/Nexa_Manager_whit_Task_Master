...
export const Text = ({
  ...
  return (
    <Component className={cn(variants[variant], colors[color], className)} {...props}>
      {children}
    </Component>
  );
};
...
export const Metric = ({ variant = 'large', className, children, ...props }) => {
  const variants = {
...
export const Label = ({ className, children, required = false, ...props }) => {
  return (
    <label className={cn('text-label text-secondary font-medium', className)} {...props}>
      {children}
...
export const NavText = ({ className, children, active = false, ...props }) => {
  return (
    <span
      className={cn(
...
export const ButtonText = ({ size = 'default', className, children, ...props }) => {
  const sizes = {
    default: 'text-button',
  ...
  return (
    <span className={cn(sizes[size], 'font-semibold', className)} {...props}>
      {children}
    </span>
  );
};
