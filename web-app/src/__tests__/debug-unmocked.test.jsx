// Unmock the testing library for this specific test
...
jest.mock('@/components/voice/VoiceFeedbackModal', () => {
  return function MockVoiceFeedbackModal({ isOpen, onClose }) {
    return isOpen ? <div data-testid="voice-feedback-modal">Mock Modal</div> : null;
  };
});

describe('VoiceFeedbackButton - Unmocked Test', () => {
  const defaultState = {
    isEnabled: true,
    isLoading: false,
