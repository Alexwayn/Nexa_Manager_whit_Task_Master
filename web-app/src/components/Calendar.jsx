...
const Calendar = () => {
  ...
  const events = {
    ...
    17: [
      { id: 5, title: eventsData.clientCall || 'Client Call', time: '3:30 PM', type: 'call', color: 'bg-green-500' },
    ],
    20: [
      {
        id: 6,
  ...
  const weekDays = Object.values(safeT('daysShort', { returnObjects: true }) || [
    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <div className="w-64 bg-white border-r border-gray-200 flex flex-col">
        ...
        <div className="p-6 border-b border-gray-200">
          ...
          <div className="grid grid-cols-7 gap-1 text-xs mb-2">
            {Object.values(safeT('daysMin', { returnObjects: true }) || [
              'S', 'M', 'T', 'W', 'T', 'F', 'S'
            ]).map((day, index) => (
        ...
        <div className="flex-1 p-6 space-y-6 overflow-y-auto">
          <div>
            <h4 className="text-sm font-medium text-gray-500 mb-3">{safeT('filters', 'Filters')}</h4>
          ...
          <div>
            <h4 className="text-sm font-medium text-gray-500 mb-3">{safeT('myCalendars', 'My Calendars')}</h4>
            <div className="space-y-2">
          ...
          <div>
            <h4 className="text-sm font-medium text-gray-500 mb-3">{safeT('eventTypes', 'Event Types')}</h4>
            <div className="space-y-2">
      ...
      <div className="w-80 bg-white border-l border-gray-200 flex flex-col">
        ...
        {selectedEvent && (
          <div className="flex-1 p-6 space-y-6 overflow-y-auto">
            <div className="flex items-center justify-between">
              <h3 className="text-lg font-semibold text-black">{safeT('eventDetails', 'Event Details')}</h3>
            ...
            <div>
              <h4 className="text-sm font-medium text-black mb-2">{safeT('description', 'Description')}</h4>
        ...
        <div className="p-6 border-t border-gray-200">
          <h3 className="text-base font-medium text-black mb-4">{safeT('newEvent', 'New Event')}</h3>
          <div className="space-y-4">
            <input
              type="text"
