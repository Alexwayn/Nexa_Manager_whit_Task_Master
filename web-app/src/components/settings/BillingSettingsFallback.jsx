...
const BillingSettingsFallback = ({ showNotification }) => {
  ...
  const handleSave = (e) => {
    ...
    showNotification && showNotification('Billing settings saved successfully (demo mode)', 'success');
  };
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        ...
        <div className="space-y-4">
          <div className="border border-gray-200 rounded-lg p-4">
            ...
            <p className="text-sm text-gray-600 mt-1">Standard invoice template with company branding</p>
          ...
          <div className="border border-gray-200 rounded-lg p-4">
            ...
            <p className="text-sm text-gray-600 mt-1">Clean, minimal design for professional invoices</p>
            <div className="mt-3 flex space-x-3">
              <button className="px-3 py-1 text-sm bg-blue-50 text-blue-700 rounded-md hover:bg-blue-100">
                Preview
              </button>
