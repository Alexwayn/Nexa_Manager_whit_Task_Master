...
const NotificationSettingsFallback = ({ settings, onSettingsChange, showNotification }) => {
  ...
  const handleSave = () => {
    ...
    showNotification && showNotification('Notification settings saved successfully (demo mode)', 'success');
  };
  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="mt-1 text-sm text-gray-600">Manage how you receive notifications and updates</p>
