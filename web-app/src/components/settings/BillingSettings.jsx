...
import { InvoiceSettingsService, TEMPLATE_TYPES, NUMBERING_FORMATS, LOGO_POSITIONS, CURRENCIES, DATE_FORMATS, NUMBER_FORMATS } from '@lib/invoiceSettingsService';
...
export default function BillingSettings({ showNotification }) {
  ...
  const generatePreview = async () => {
    try {
      const preview = InvoiceSettingsService.generatePreview(invoiceSettings, selectedTemplate?.config || {});
  ...
  const handleEditPaymentMethod = (methodId) => {
    showNotification && showNotification(t('billing.alerts.editPaymentMethodInfo', { methodId }), 'info');
  };
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) => handleInvoiceSettingChange('numbering_format', e.target.value)}
                        className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                      >
                        <option value={NUMBERING_FORMATS.SEQUENTIAL}>{t('billing.numbering.sequential')}</option>
                        <option value={NUMBERING_FORMATS.DATE_BASED}>{t('billing.numbering.dateBased')}</option>
                        <option value={NUMBERING_FORMATS.YEARLY_RESET}>{t('billing.numbering.yearlyReset')}</option>
                        <option value={NUMBERING_FORMATS.CUSTOM}>{t('billing.numbering.custom')}</option>
                      </select>
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => handleInvoiceSettingChange('next_number', parseInt(e.target.value))}
                        className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                      />
                    </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      >
                        ...
                        <option value={LOGO_POSITIONS.CENTER}>{t('billing.branding.center')}</option>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) => handleInvoiceSettingChange('payment_terms', parseInt(e.target.value))}
                        className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                      >
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => handleInvoiceSettingChange('tax_rate', parseFloat(e.target.value))}
                        className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                      />
                    </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center">
                      <input
                        ...
                        onChange={(e) => handleInvoiceSettingChange('auto_reminders', e.target.checked)}
                    ...
                    <div className="flex items-center">
                      <input
                        ...
                        onChange={(e) => handleInvoiceSettingChange('include_tax_breakdown', e.target.checked)}
                        className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                      />
                    ...
                    <div className="flex items-center">
                      <input
                        ...
                        onChange={(e) => handleInvoiceSettingChange('include_notes', e.target.checked)}
                        className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                      />
                    ...
                    {invoiceSettings.auto_reminders && (
                      <div className="ml-6">
                        ...
                        <input
                          ...
                          onChange={(e) => handleInvoiceSettingChange('reminder_days', e.target.value)}
                          placeholder="7,14,30"
                          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                        />
                        <p className="text-xs text-gray-500 mt-1">{t('billing.options.reminderDaysHelp')}</p>
                      </div>
                    )}
                  </div>
                </div>
                    ...
                    {showPreview && (
                      <div className="bg-gray-50 border rounded-lg p-4">
                        <div className="text-sm space-y-2">
                          <div><strong>{t('billing.preview.number')}:</strong> {previewData.invoiceNumber}</div>
                          <div><strong>{t('billing.preview.template')}:</strong> {selectedTemplate?.name || 'Default'}</div>
                          <div><strong>{t('billing.preview.currency')}:</strong> {invoiceSettings.currency}</div>
                          <div><strong>{t('billing.preview.terms')}:</strong> {invoiceSettings.payment_terms} {t('billing.business.days')}</div>
                          <div><strong>{t('billing.preview.taxRate')}:</strong> {invoiceSettings.tax_rate}%</div>
                        </div>
                      </div>
                    )}
                  </div>
