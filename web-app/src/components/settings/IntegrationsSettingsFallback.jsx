...
export default function IntegrationsSettingsFallback({ showNotification }) {
  ...
  const handleConnect = (integrationId) => {
    console.log('🔗 IntegrationsSettingsFallback: Connecting integration (Demo Mode)', integrationId);
    if (showNotification) {
  ...
  const handleDisconnect = (integrationId) => {
    console.log('🔗 IntegrationsSettingsFallback: Disconnecting integration (Demo Mode)', integrationId);
    if (showNotification) {
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white shadow rounded-lg">
        <div className="px-6 py-4 border-b border-gray-200">
          ...
          <p className="text-sm text-gray-500">Connetti servizi esterni per migliorare il tuo workflow</p>
        </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500">Sincronizza automaticamente i dati con i servizi connessi</p>
            </div>
