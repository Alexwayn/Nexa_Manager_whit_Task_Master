...
export const MonitoringDashboard: React.FC<MonitoringDashboardProps> = ({
  ...
  const overallScore = Math.round(
    (metrics.performance.score + metrics.accessibility.score) / 2
  );
            ...
            <div className="space-y-1 text-sm text-gray-600">
              ...
              {Object.keys(metrics.accessibility.impactSummary).length > 0 && (
                <div className="mt-2">
                  ...
                  {Object.entries(metrics.accessibility.impactSummary).map(([impact, count]) => (
                    count > 0 && (
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                  <div>
                    ...
                    <p className="text-gray-600">{metrics.performance.avgRenderTime.toFixed(2)}ms</p>
                  </div>
                  <div>
