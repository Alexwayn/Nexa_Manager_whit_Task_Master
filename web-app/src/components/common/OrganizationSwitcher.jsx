  ...
  if (needsOrganizationCreation) {
    return (
      ...
      >
        ...
        <span className="hidden lg:inline">{safeT('organization.create', 'Create Organization')}</span>
      </button>
    );
  }
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0 text-left">
                            <p className={classNames(
                              isCurrentOrg ? 'text-blue-900 dark:text-blue-100 font-medium' : 'text-gray-900 dark:text-gray-100',
                              'truncate'
                            )}>
                              {org.name}
                            </p>
                            <p className="text-xs text-gray-500 dark:text-gray-400 capitalize">
                              {orgMembership.role?.replace('_', ' ')} • {org.membersCount || 0} {safeT('organization.members', 'members')}
                            </p>
                          </div>
