          ...
          >
            ...
            <div className="space-y-2 text-sm text-gray-600">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium">{emailService.getEstimatedDeliveryTime(provider.id)}</span>
              </div>
            </div>
            ...
            {testResults[provider.id] && (
              <div className={`mt-4 p-3 rounded-md ${
                testResults[provider.id].success ? 'bg-green-50 border border-green-200' : 'bg-red-50 border border-red-200'
              }`}>
                <div className="flex items-center">
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-md p-4 mt-6">
                <div className="flex">
                  ...
                  <div className="text-sm text-yellow-800">
                    ...
                    <p className="mt-1">
                      In production, these credentials should be stored as environment variables or in a secure configuration management system.
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
        <div className="flex">
          ...
          <div className="text-sm text-blue-800">
            ...
            <p className="mt-1">
              To configure email providers, set the appropriate environment variables in your .env file:
            </p>
            ...
            <p className="mt-2">
              Currently using mock provider for development. Configure a real provider for production use.
            </p>
          </div>
        </div>
      </div>
