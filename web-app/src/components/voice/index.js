...
export { default as VoiceActivationButton } from './VoiceActivationButton';
...
export { VoiceFeedbackButton, VoiceFeedbackFloatingButton } from './VoiceFeedbackButton';
export { CommandSuggestionModal, CommandSuggestionsList } from './CommandSuggestion';
export { default as VoiceFeedbackAnalytics } from './VoiceFeedbackAnalytics';
export { default as FeedbackAnalysisTools } from './FeedbackAnalysisTools';