      ...
      >
        ...
        {commandData.command && (
          <div className="mb-4 p-3 bg-gray-50 rounded-md">
            ...
            <p className="font-medium" data-testid="modal-command">"{commandData.command}"</p>
            {commandData.action && (
              <>
            ...
            {commandData.confidence && (
              <>
                ...
                <p className="font-medium" data-testid="modal-confidence">{commandData.confidence}</p>
              </>
            )}
          </div>
        )}
          ...
          <div className="mb-4">
            ...
            <div className="grid grid-cols-3 gap-2">
              {feedbackTypes.map((type) => {
                ...
                // Define explicit classes for each feedback type
