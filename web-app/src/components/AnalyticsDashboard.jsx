      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-200 dark:border-gray-700 hover:shadow-md transition-shadow duration-200">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-3xl font-bold text-gray-900 dark:text-white mt-2">
              {analyticsData?.totalExpenses ? `€${analyticsData.totalExpenses.toLocaleString()}` : '€0'}
            </p>
            <div className="flex items-center mt-2">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-sm border border-gray-200 dark:border-gray-700">
        ...
        <div className="h-80">
          <Doughnut
            data={{
              labels: analyticsData?.categoryDistribution.map((d) => d.category) || ['Office Supplies', 'Travel', 'Marketing', 'Equipment', 'Other'],
              datasets: [
                {
                  data: analyticsData?.categoryDistribution.map((d) => d.amount) || [30, 25, 20, 15, 10],
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
            <div className="mb-6 lg:mb-0">
              ...
              <p className="mt-2 text-lg text-gray-600 dark:text-gray-400">
                {safeT('trackFinancialPerformance', {}, 'Monitor your business performance and financial insights')}
              </p>
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              >
                ...
                {layoutEditMode ? safeT('exitEdit', {}, 'Exit Edit') : safeT('editLayout', {}, 'Edit Layout')}
              </button>
              <button
              ...
              >
                ...
                {compareMode ? safeT('exitCompare', {}, 'Exit Compare') : safeT('compare', {}, 'Compare')}
              </button>
            </div>
          </div>
        </div>
