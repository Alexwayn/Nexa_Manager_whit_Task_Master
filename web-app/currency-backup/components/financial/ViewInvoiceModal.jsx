...
const ViewInvoiceModal = ({ isOpen, onClose, invoice }) => {
  ...
  const getStatusBadge = (status) => {
    const statusConfig = {
      ...
      pending: { bg: 'bg-yellow-100', text: 'text-yellow-800', label: t('status.pending', 'Pending') },
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="text-sm text-gray-500">{t('invoice.number', 'Invoice Number')}</p>
                      <p className="font-semibold text-gray-900">#{invoice.invoice_number || invoice.id}</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="text-sm text-gray-500">{t('invoice.client.name', 'Client Name')}</p>
                  ...
                  {invoice.client_email && (
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="text-sm text-gray-500">{t('invoice.client.email', 'Email')}</p>
